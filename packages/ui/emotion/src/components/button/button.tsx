...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant, size, children, disabled, onClick, className, pending = false, stretch = false }, ref) => {
    ...
    const label = useMemo(() => {
      ...
      return (
        <Text typography={typography} color={typographyColor} className={TextClassName}>
          {children}
        </Text>
      );
